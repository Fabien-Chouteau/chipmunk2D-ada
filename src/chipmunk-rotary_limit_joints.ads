...
is
   ...
   function cpConstraintIsRotaryLimitJoint
     (constraint : cpConstraint) return cpBool;
   --
   pragma
     Import
       (C, cpConstraintIsRotaryLimitJoint, "cpConstraintIsRotaryLimitJoint");
   ...
   function Init
     (joint : cpRotaryLimitJoint;
      a     : cpBody;
      b     : cpBody;
      min   : cpFloat;
      max   : cpFloat) return cpRotaryLimitJoint;
   --
   pragma Import (C, Init, "cpRotaryLimitJointInit");

   function NewRotaryLimitJoint
     (a : cpBody; b : cpBody; min : cpFloat; max : cpFloat)
      return cpConstraint;
   --
