...
is
   ...
   type cpDampedSpringForceFunc is
     access function  (spring : cpConstraint; dist : cpFloat) return cpFloat

   with Convention => C;

   function cpConstraintIsDampedSpring
   ...
   function Init
     (joint      : cpDampedSpring;
      ...
      restLength : cpFloat;
      stiffness  : cpFloat;
      damping    : cpFloat) return cpDampedSpring;
   --
   pragma Import (C, Init, "cpDampedSpringInit");

   function NewDampedSpring
     (a          : cpBody;
      b          : cpBody;
      anchorA    : cpVect;
      anchorB    : cpVect;
   ...
   function GetSpringForceFunc
     (constraint : cpConstraint) return cpDampedSpringForceFunc;
   --
   pragma Import (C, GetSpringForceFunc, "cpDampedSpringGetSpringForceFunc");

   procedure SetSpringForceFunc
     (constraint : cpConstraint; springForceFunc : cpDampedSpringForceFunc);
   --
