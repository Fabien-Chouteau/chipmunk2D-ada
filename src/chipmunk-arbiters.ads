...
is
   ...
   procedure GetShapes
     (arb : cpArbiter; a : access cpShape; b : access cpShape);
   --
   ...
   procedure SetContactPointSet
     (arb : cpArbiter; set : access cpContactPointSet);
   --
   ...
   --
   pragma
     Import (C, CallWildcardPostSolveA, "cpArbiterCallWildcardPostSolveA");

   procedure CallWildcardPostSolveB (arb : cpArbiter; space : cpSpace);
   --
   pragma
     Import (C, CallWildcardPostSolveB, "cpArbiterCallWildcardPostSolveB");
