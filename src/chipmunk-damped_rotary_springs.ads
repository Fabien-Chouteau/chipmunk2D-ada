...
is
   ...
   type cpDampedRotarySpringTorqueFunc is
     access function
       (spring : cpConstraint; relativeAngle : cpFloat) return cpFloat

   with Convention => C;

   function cpConstraintIsDampedRotarySpring
   ...
   function Init
     (joint     : cpDampedRotarySpring;
      a         : cpBody;
      b         : cpBody;
      restAngle : cpFloat;
      stiffness : cpFloat;
      damping   : cpFloat) return cpDampedRotarySpring;
   --
   pragma Import (C, Init, "cpDampedRotarySpringInit");

   function NewDampedRotarySpring
     (a         : cpBody;
      b         : cpBody;
      restAngle : cpFloat;
      stiffness : cpFloat;
      damping   : cpFloat) return cpConstraint;
   --
   ...
   function GetSpringTorqueFunc
     (constraint : cpConstraint) return cpDampedRotarySpringTorqueFunc;
   --
   pragma
     Import
       (C, GetSpringTorqueFunc, "cpDampedRotarySpringGetSpringTorqueFunc");

   procedure SetSpringTorqueFunc
     (constraint       : cpConstraint;
      springTorqueFunc : cpDampedRotarySpringTorqueFunc);
   --
   pragma
     Import
       (C, SetSpringTorqueFunc, "cpDampedRotarySpringSetSpringTorqueFunc");
